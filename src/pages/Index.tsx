    ...
    <div className="container mx-auto px-4 md:px-6 h-14 md:h-16 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <a 
          ...
          className="inline-flex items-center gap-1.5 md:gap-2 px-4 py-2 md:px-5 md:py-2.5 bg-primary text-primary-foreground rounded-full text-sm md:text-base font-medium hover:bg-primary/90 transition-all hover:shadow-lg hover:shadow-primary/25"
        >
      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <header className="max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-start gap-3 md:gap-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            <a 
              href="#demo"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 md:px-8 md:py-4 bg-background border-2 border-border text-foreground rounded-full font-semibold hover:border-primary/50 hover:bg-primary/5 transition-all"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto">
          {courses.map((course, index) => (
            ...
            >
              ...
              {course.available && (
                <div className="absolute top-3 right-3 md:top-4 md:right-4 px-2 py-0.5 md:px-3 md:py-1 rounded-full bg-primary/10 text-primary text-[10px] md:text-xs font-medium border border-primary/20">
                  Available Now
                </div>
              )}
    ...
    <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 md:gap-4">
          ...
          <a 
            href="#demo"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 md:px-8 md:py-4 bg-transparent border-2 border-white/30 text-white rounded-full font-semibold hover:bg-white/10 transition-all"
          >
            <Play className="w-4 h-4 md:w-5 md:h-5" />
            See Demo
          </a>
    ...
    <div className="container mx-auto px-4 md:px-6">
      <div className="flex flex-col items-center gap-4 md:gap-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8">
          ...
          <a href="#courses" className="text-muted-foreground hover:text-foreground transition-colors text-xs md:text-sm">Courses</a>
