import { BookOpen, Users, TrendingUp, Code, Lightbulb, BarChart3 } from "lucide-react";
  ...
  <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/50">
    <div className="container mx-auto px-6 h-16 flex items-center justify-between">
      <div className="flex items-center gap-2">
        ...
        <span className="font-serif text-xl font-semibold text-foreground">EduInsight</span>
      </div>
    ...
    <div className="container mx-auto px-6">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-2">
          ...
          <span className="font-serif text-xl font-semibold">EduInsight</span>
        </div>
        <p className="text-muted-foreground text-sm">
          © 2025 EduInsight. Empowering educators with interactive learning.
        </p>
      </div>
    </div>
  </footer>
